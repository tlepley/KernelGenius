...
public class C_ABI_ilp32 implements ABI {

  public static final C_ABI_ilp32 abi = new C_ABI_ilp32();
  ...
  static final BigInteger LONG_MAX   = BigInteger.ONE.shiftLeft(31).subtract(BigInteger.ONE);
  static final BigInteger ULONG_MAX  = BigInteger.ONE.shiftLeft(32).subtract(BigInteger.ONE);
  static final BigInteger LLONG_MAX  = BigInteger.ONE.shiftLeft(63).subtract(BigInteger.ONE);
  static final BigInteger ULLONG_MAX = BigInteger.ONE.shiftLeft(64).subtract(BigInteger.ONE);
  ...
  public int getLongdoubleSize() { return 12;}
